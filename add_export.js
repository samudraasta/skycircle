...
// Insert Export Buttons in screenGradePicker
const exportUI = `
...
// Insert exportClassProfiles function
const exportScript = `
    function exportClassProfiles(grade) {
        ...
        classProfiles.forEach(p => {
            ...
            const themeColor = p.kelompok && p.kelompok.startsWith('GC') ? '#d81b60' : '#1e88e5';
            
            // Re-use base64BgBoy and base64BgGirl logic if possible. We'll use base64BgBoy as default for this batch since we don't have base64BgGirl readily defined in global scope.
            // Wait, we need the background base64! 
            // In buku-saku.html, base64BgBoy is defined inside renderHTML. Let's just fetch it from the same URL directly via img tag in print, or embed the base64!
        });
`;
